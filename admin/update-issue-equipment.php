...
<head>
    ...
    <title>E-Sports | Update Issue</title>
...
<body>
    ...
    <!-- ปุ่มคืนอุปกรณ์กีฬา -->
    <a href="manage-issued-equipment.php" class="btn btn-primary"><i class="fa fa-arrow-left"></i> ย้อนกลับ</a>
