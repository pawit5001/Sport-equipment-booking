...
<div class="col-md-12">
<h4 class="header-line">เปลี่ยนรหัสผ่าน (สำหรับเจ้าหน้าที่)</h4>
</div>
</div>
 <?php if($error){?><div class="errorWrap"><strong>พบข้อผิดพลาด</strong>:<?php echo htmlentities($error); ?> </div><?php } 
